            ...
            <div className='flex-1 bg-white w-full mb-8 border border-gray-300
              ...
              <form className='flex flex-col gap-y-4'>
                ...
                <textarea className='border border-gray-300 focus:border-violet-700 
                  ...
                  placeholder='Message*' /* defaultValue="Hello I am interesed in [Modern apartment
                  ]" */></textarea>
                <div className='flex gap-x-2'>
                  ...
                  hover:border-violet-500 hover:text-violet-500 rounded p-4 text-sm w-full transition'>Call</button>
                </div>
              </form>
            </div>
          </div>
